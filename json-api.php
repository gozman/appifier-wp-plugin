<?php
/*
Plugin Name: Appifier Plugin
Plugin URI: http://wordpress.org/extend/plugins/appifier/
Description: A plugin to enable Wordpress users to build apps using Appifier. Adapted from the work of Dan Phiffer (JSON-API)
Version: 1.0
Author: Dan Phiffer & Appifier LLC
...
@include_once "$dir/models/menu_item.php";
